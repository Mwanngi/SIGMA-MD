...
global.owner = process.env.OWNER_NUMBER  || '254781263753' ;  // ADD YOUR NUMBER WITHOUT +
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '04_08_2024_SIGMA_MD_dK3Dufpu_MAHER_ZUBAIR',                // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'PoTmo',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `Alvino', // ADD YOUR NAME
